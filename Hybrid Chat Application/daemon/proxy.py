...
# global_last_used_index = -1
# global_robin_lock = threading.Lock()
...
#         #   policy
#         elif len(proxy_map) > 1:
#             global global_last_used_index, global_robin_lock
#             with global_robin_lock:
#                 if global_last_used_index == len(proxy_map) - 1:
#                     global_last_used_index = 0
#                 else:
#                     global_last_used_index += 1
#                 print("[Proxy] resolve route of hostname {} is a round-robin to index {}".format(hostname, global_last_used_index))
#                 proxy_host, proxy_port = proxy_map[global_last_used_index].split(":", 2)
...
#             #        provided handle_client routine
#             #
#             proxy_thread = threading.Thread(target=handle_client, args=(ip, port, conn, addr, routes))
